...
class TourIntro extends Component {
  render() {
    return (
      <section className='col-12 p-0 m-0 d-flex flex-wrap my-6'>
        <div className="my-6 col-12">
          <div className="text-center col-12">
            <h1 className='display-5 m-0 text-bold text-uppercase'>Επισκευθειτε το μπαλι</h1>
            <h2 className='display-6 m-1 text-normal'>Ζειστε την εμπειρια</h2>
          </div>
